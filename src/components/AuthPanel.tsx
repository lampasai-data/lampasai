...
// Google's official sign-in mark, inline rather than an asset: it renders at
// 16x16 and the PNG it replaces weighed 250 kB - roughly a fifth of the whole
// JS bundle, downloaded by everyone who opened the auth panel.
