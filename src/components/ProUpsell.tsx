export default function ProUpsell({ certName }: { certName: string }) {
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-violet-400/30 bg-violet-500/10 p-7 text-center">
      ...
      <a
        ...
        className="mt-6 inline-block rounded-full bg-violet-500 px-7 py-3.5 text-sm font-medium text-white transition hover:bg-violet-400"
      >
