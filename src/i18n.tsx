...
const translations: Record<Lang, Translations> = {
  fr: {
    ...
    formations: {
      ...
      comingSoonDesc: "Nous préparons des parcours de formation complets (Power BI, Snowflake, IA appliquée...). Contacte-nous via le formulaire ci-dessous pour être informé en priorité.",
  ...
  en: {
    ...
    formations: {
      ...
      comingSoonDesc: "We're building complete training paths (Power BI, Snowflake, applied AI...). Contact us via the form below to be notified first.",
